    ...
    <div className="animate-fade-in space-y-8">
      ...
      <div className="rounded-2xl border border-primary-100 bg-primary-50/50 px-6 py-3">
        <p className="text-xs text-primary-600/70">
          🛡️ All employee data is processed locally. No demographic attributes are used in
  ...
  return (
    ...
    >
      ...
      <div className="space-y-3">
        ...
        {/* Growth Area (positive reframe of failure) */}
        <div className="flex items-center gap-2 text-sm">
        ...
        <div className="h-2 w-full rounded-full bg-surface-100">
          <div
            className={`h-full rounded-full transition-all duration-500 ${
              emp.soft_skill_score >= 8 ? 'bg-gradient-to-r from-emerald-400 to-emerald-500' :
              emp.soft_skill_score >= 6 ? 'bg-gradient-to-r from-amber-400 to-amber-500' :
